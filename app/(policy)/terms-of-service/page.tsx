...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Terms of Service - sprunki",
    alternates: {
...
Welcome to **sprunki Music Mixer** (sprunki.to), an interactive music creation platform that combines digital art with creative sound design. By accessing or using our service, you agree to be bound by these Terms of Service.

## Use of the Service

sprunki Music Mixer provides an interactive platform where users can:
- Create unique musical compositions using our digital interface
- Experience creative art and interactive sound design
- Save and share musical creations
- Use the sprunki Mod features
...
1. **Your Creations**: You retain rights to the musical compositions you create using sprunki Music Mixer.

2. **Platform License**: By creating and sharing content through our platform, you grant sprunki Music Mixer a non-exclusive license to host, display, and enable sharing of your creations.
...
1. **Platform Rights**: The sprunki Music Mixer platform, including its interface, artwork, sound effects, and original content, is protected by copyright law.
...
THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND. sprunki MUSIC MIXER DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.

## Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW, sprunki MUSIC MIXER SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES ARISING FROM YOUR USE OF THE SERVICE.

## Children's Use

1. sprunki Music Mixer is designed to be family-friendly.
...
[contact@sprunki.to](mailto:contact@sprunki.to)

---

Last updated: ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}

By using sprunki Music Mixer, you acknowledge that you have read and agree to these Terms of Service.`;
